...
\begin{figure}[H]
	...
	\caption{Revised draft of the complete joint board block diagram}
	\label{fig:2nd_joint_board_block}
\end{figure}
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.4]{link_block_diagram}
	\caption{Cleaned up version of the first draft complete joint board block diagram}
	\label{fig:nice_1st_joint_board_block}
\end{figure}
