...
\begin{table}[H]
	...
	\begin{tabular}{|p{4.5cm}|p{1.5cm}|p{2cm}|p{1.7cm}|c|p{1.4cm}|}
\hline
Part name & Supply Voltage (V) & Current Range (A) & Sensitivity (mV/A) & Output & Built in filter? \\
\hline

ACS722LLCTR-05AB-T & 3.3 & -5 to +5 & 264 & Analog & y \\

ACS723LLCTR-05AB-T & 5 & -5 to +5 & 400 & Analog & y \\

ACS724LLCTR-10AB-T & 5 & -10 to +10 & 200 & Analog & n \\

ACS725LLCTR-10AU-T & 3.3 & 0 to +10 & 264 & Analog & n \\
\hline
